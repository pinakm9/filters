...
"""
enkf = fl.EnsembleKF(model, ensemble_size = 200, jac_h_x = model3.jac_h_x, jac_o_x = model3.jac_o_x)
enkf.update(observed_path)

# plot trajectories
image_dir = str(script_path.parent.parent.parent) + '/images/EnsembleKF/'
model_name = 'model3'
enkf.plot_trajectories(hidden_path, coords_to_plot = [0, 1], show = True, file_path = image_dir + model_name + '_trajectories.png')
