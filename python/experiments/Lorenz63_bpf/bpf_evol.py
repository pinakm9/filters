...
shift = 0.0
obs_gap = 0.2
model, gen_path = Lorenz63.get_model(size=ev_time, prior_cov=prior_cov, obs_cov=obs_cov,  shift=shift, obs_gap=obs_gap)
...
expr_name = 'np_{}_rn_{}_pc_{}_oc_{}_og_{}_s_{}'.format(particle_count, noise, prior_cov, obs_cov, obs_gap, shift)
