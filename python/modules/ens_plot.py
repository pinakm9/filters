...
@ut.timer
def plot_ensemble_evol(db_path, hidden_path,\
    ...
    w = np.ones(len(getattr(hdf5.root.prior_ensemble, 'time_' + str(t)).read().tolist()))
    ...
    for t, observation in enumerate(observations):
        ...
        file_path = os.path.dirname(db_path) + '/ensembles_{}.png'.format(t)
    ...
    ep.stich(folder = os.path.dirname(db_path), img_prefix = 'enkf_ensembles', pdf_name = 'enkf_evolution.pdf', clean_up = True,\
