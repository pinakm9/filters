...
# set parameters
s = int(sys.argv[1])
model, a, b, x0 = model5.model(size = s)
db_id = '14_3_4'
...
config = {'Henon a': a, 'Henon b': b, 'Attractor database': db_path, 'Attractor id': db_id, 'Attractor resampling scheme': resample_id,\
          'Particle count': particle_count, 'Number of experiments': num_exprs, 'Resampling threshold': resampling_threshold,\
          'Evolution time': s, 'Model': 'model5', 'Starting point': x0}
