...
for file in config_files[1:2]:
    ...
    pf = gpf.GeneticPF(model, particle_count = particle_count, record_path = cc.res_path + '/assimilation.h5', generations_per_step=10)
    ...
    pf.plot_trajectories(hidden_path, coords_to_plot=[0, 8, dim-1], file_path=cc.res_path + '/trajectories.png', measurements=False)
